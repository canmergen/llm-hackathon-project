...
> **📄 Detaylı Dokümantasyon:** Projenin tüm çalışma mantığını (Chunking, Hybrid Search, Karar Motoru) adım adım incelemek için [**Otonom_RAG_Mimari_Raporu.pdf**](docs/Otonom_RAG_Mimari_Raporu.pdf) dosyasını okuyabilirsiniz.
